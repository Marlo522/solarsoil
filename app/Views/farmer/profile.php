...
<input type="text" name="first_name" value="<?= esc($user['first_name']) ?>" class="w-full px-4 py-2 border rounded-lg">

<input type="text" name="middle_name" value="<?= esc($user['middle_name']) ?>" class="w-full px-4 py-2 border rounded-lg">

<input type="text" name="last_name" value="<?= esc($user['last_name']) ?>" class="w-full px-4 py-2 border rounded-lg">

<input type="text" name="contact_number" value="<?= esc($user['contact_number']) ?>" class="w-full px-4 py-2 border rounded-lg">

<textarea name="address" class="w-full px-4 py-2 border rounded-lg"><?= esc($user['address']) ?></textarea>
