                ...
                <?php if (!empty($orders)): ?>
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 text-center">
                            ...
                            <button onclick="if(confirm('Are you sure you want to delete this order?')) window.location='<?= base_url('admin/orders/delete/' . $order['order_id']) ?>'" class="text-sm text-red-500 hover:text-red-700 font-medium">Delete</button>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center text-sm text-gray-400">No orders found.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
