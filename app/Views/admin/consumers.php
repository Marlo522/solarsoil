...
<form method="GET" action="<?= base_url('admin/consumers') ?>" class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
    <div class="relative w-full sm:w-64">
        ...
        <input type="text" name="search" placeholder="Search Consumer ID or Name..."
               value="<?= esc($search ?? '') ?>"
            ...
            <tbody class="divide-y divide-gray-100">
                <?php if (!empty($consumers)): ?>
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-6 py-4 text-sm font-medium text-gray-900">#<?= esc($consumer['user_id']) ?></td>
...
<div class="flex items-center justify-center gap-2 mt-6">
    <?php if ($currentPage > 1): ?>
        <a href="<?= base_url('admin/consumers?page=' . ($currentPage - 1) . $qs) ?>" class="px-3 py-1.5 text-sm text-gray-600 border border-gray-200 rounded-lg hover:bg-gray-50 transition">Prev</a>
    <?php endif; ?>

    <?php for ($i = 1; $i <= $totalPages; $i++): ?>
        <a href="<?= base_url('admin/consumers?page=' . $i . $qs) ?>"
    ...
    <?php if ($currentPage < $totalPages): ?>
        <a href="<?= base_url('admin/consumers?page=' . ($currentPage + 1) . $qs) ?>" class="px-3 py-1.5 text-sm text-gray-600 border border-gray-200 rounded-lg hover:bg-gray-50 transition">Next</a>
    <?php endif; ?>
</div>
<?php endif; ?>
