...
<?php
$products = $products ?? [
    ['product_id' => 1, 'name' => 'Fresh Tomatoes',   'category' => 'Vegetables', 'price' => 80.00,  'stock_quantity' => 100, 'seller' => 'Juan Dela Cruz',  'status' => 'active',   'date_added' => '2024-12-01'],
    ['product_id' => 2, 'name' => 'Carrots',          'category' => 'Vegetables', 'price' => 60.00,  'stock_quantity' => 150, 'seller' => 'Maria Santos',    'status' => 'active',   'date_added' => '2024-12-02'],
    ['product_id' => 3, 'name' => 'Bananas',          'category' => 'Fruits',     'price' => 50.00,  'stock_quantity' => 200, 'seller' => 'Pedro Garcia',    'status' => 'active',   'date_added' => '2024-12-03'],
    ['product_id' => 4, 'name' => 'Lettuce',          'category' => 'Vegetables', 'price' => 40.00,  'stock_quantity' => 0,   'seller' => 'Juan Dela Cruz',  'status' => 'out_of_stock', 'date_added' => '2024-12-04'],
    ['product_id' => 5, 'name' => 'Sweet Mangoes',    'category' => 'Fruits',     'price' => 120.00, 'stock_quantity' => 60,  'seller' => 'Maria Santos',    'status' => 'active',   'date_added' => '2024-12-05'],
    ['product_id' => 6, 'name' => 'Potatoes',         'category' => 'Vegetables', 'price' => 70.00,  'stock_quantity' => 120, 'seller' => 'Pedro Garcia',    'status' => 'active',   'date_added' => '2024-12-06'],
    ['product_id' => 7, 'name' => 'Red Apples',       'category' => 'Fruits',     'price' => 150.00, 'stock_quantity' => 90,  'seller' => 'Juan Dela Cruz',  'status' => 'active',   'date_added' => '2024-12-07'],
    ['product_id' => 8, 'name' => 'Organic Basil',    'category' => 'Herbs',      'price' => 35.00,  'stock_quantity' => 50,  'seller' => 'Maria Santos',    'status' => 'inactive', 'date_added' => '2024-12-08'],
    ['product_id' => 9, 'name' => 'Fresh Oranges',    'category' => 'Fruits',     'price' => 100.00, 'stock_quantity' => 110, 'seller' => 'Pedro Garcia',    'status' => 'active',   'date_added' => '2024-12-09'],
    ['product_id' => 10,'name' => 'Eggplant',         'category' => 'Vegetables', 'price' => 55.00,  'stock_quantity' => 70,  'seller' => 'Juan Dela Cruz',  'status' => 'active',   'date_added' => '2024-12-10'],
];
    ...
    <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-lg max-h-[90vh] overflow-y-auto" @click.stop>
        ...
        <form method="POST" enctype="multipart/form-data" class="p-6 space-y-4">
            ...
            <div>
                ...
                <textarea name="description" rows="3" x-model="editProduct.description" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 transition resize-none" placeholder="Describe the product..."></textarea>
            </div>
